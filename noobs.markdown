...
I do recommend you just get [Stack](http://docs.haskellstack.org/en/stable/README/) right off the bat and look through some of its documentation. The documentation for it is fairly thorough.
...
- If you really can't wait, try [this post](posts/2018-01-23-the-nesting-instinct.html)
